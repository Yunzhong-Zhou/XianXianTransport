...
import com.transport.xianxian.model.Auth_RenLianModel;
 ...
 * 人脸
 */
public class Auth_RenLianActivity extends BaseActivity {
    //选择图片及上传
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_auth_renlian);
    }
...
//        this.showLoadingPage();
    ...
    private void Request(String string) {
        OkHttpClientManager.getAsyn(this, URLs.Auth_CheZhu + string,
                new OkHttpClientManager.ResultCallback<Auth_RenLianModel>() {
                    @Override
                    public void onError(Request request, String info, Exception e) {
                        hideProgress();
                        if (!info.equals("")) {
                    ...
                    @Override
                    public void onResponse(final Auth_RenLianModel response) {
                        hideProgress();
                        MyLogger.i(">>>>>>>>>车主认证-上传人脸" + response);
                        if (!response.getFace_image().equals("")) {
                            imageView1.setVisibility(View.VISIBLE);
                            linearLayout1.setVisibility(View.GONE);
                            Glide.with(Auth_RenLianActivity.this)
                                    .load(IMGHOST + response.getFace_image())
                                    .centerCrop()
